function x = prima_single(fun, x0, xl, xu, Aineq, bineq, Aeq, beq, cub, ceq)
%PRIMA_SINGLE  Wrap PRIMA solver with single precision for OptiProfiler
...
%   linearly constrained, nonlinearly constrained) with single precision.

    % Configure PRIMA options: use single precision
    opts = struct();
