function x = prima_quadruple(fun, x0, xl, xu, Aineq, bineq, Aeq, beq, cub, ceq)
%PRIMA_QUADRUPLE  Wrap PRIMA solver with quadruple precision for OptiProfiler
...
%   linearly constrained, nonlinearly constrained) with quadruple precision.

    % Configure PRIMA options: use quadruple precision
    opts = struct();
    opts.precision = 'quadruple';
